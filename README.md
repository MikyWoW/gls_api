...
$pickupAddress->HouseNumber = '123/88';
...
$deliveryAddress->HouseNumber = '256/1';
...
$lang->Depot = 'Depo:';
$lang->Driver = 'Řidič:';
$lang->glsText = 'Veškeré služby jsou poskytovány výhradně na základě aktuálních všeobecných obchodních podmínek. Podrobnosti o zásadách ochrany osobních údajů: https://gls-group.eu/CZ/cs/ochrana-osobnich-udaju';
