...
class Ticket
{
    public static function getTicket($PrintDataInfo, string $currency = '', Language $lang)
    {
        ...
        for ($i = 0; $i < $PrintDataInfo->Parcel->Count; $i++)
        {
            ...
            ^FO490,420
            ^AZR23,23
            ^FD{$PrintDataInfo->Parcel->DeliveryAddress->ContactName} {$PrintDataInfo->Parcel->DeliveryAddress->ContactPhone}^FS
            ...
            ^FO130,700
            ^AZR23,23
            ^FD{$PrintDataInfo->Parcel->PickupAddress->Street} {$PrintDataInfo->Parcel->PickupAddress->HouseNumber}^FS
            ...
            ^FO25,700
            ^AZR23,23
            ^FD{$PrintDataInfo->Parcel->PickupAddress->ContactName} {$PrintDataInfo->Parcel->PickupAddress->ContactPhone}^FS
